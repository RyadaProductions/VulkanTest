...
void VulkanRenderPipeline::createGraphicsPipeline(VkDevice device, VulkanRenderPass renderPass, VkExtent2D swapChainExtent) {
...
VkShaderModule VulkanRenderPipeline::createShaderModule(VkDevice device, const std::vector<char>& code) {
